...
namespace Moo
{
	...
	void	Camera::resetToPlayer(Hitbox hitbox)
	{
		...
		std::cout << "hitbox.x1 : " << std::setprecision(3) << hitbox.x1 << std::endl;
		std::cout << "hitbox.y1 : " << std::setprecision(3) << hitbox.y1 << std::endl;
		std::cout << "_mapInfos->getMapWidth() : " << std::setprecision(3) << _mapInfos->getMapWidth() << std::endl;
		std::cout << "_mapInfos->getMapHeight() : " << std::setprecision(3) << _mapInfos->getMapHeight() << std::endl;
	}
